...
public class MedicalGroupDirectory extends WebAPI {
    ...
    @FindBy(xpath = "//span[contains(text(),'Presbyterian Medical Group Directory')]") public WebElement medicalGroupDirectory1;
    ...
    public void checkMedicalGroupDirectory(){

       medicalGroupDirectory1.click();
    }
