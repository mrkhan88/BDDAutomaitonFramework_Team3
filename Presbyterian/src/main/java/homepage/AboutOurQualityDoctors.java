...
public class AboutOurQualityDoctors extends WebAPI {
    ...
    @FindBy(xpath = "//span[contains(text(),'About Our Quality Doctors')]") public WebElement aboutOurQualityDoctors1;
    ...
    public void checkAboutOurQualityDoctors(){

        aboutOurQualityDoctors1.click();
    }
