...
public class SleepMedicine extends WebAPI {
    ...
    @FindBy(xpath = "//span[contains(text(),'Sleep Medicine')]") public WebElement sleepMedicine1;
    ...
    public void checkSleepMedicine(){

        sleepMedicine1.click();
    }
