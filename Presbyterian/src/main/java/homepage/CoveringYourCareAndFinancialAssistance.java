...
public class CoveringYourCareAndFinancialAssistance extends WebAPI {
    ...
    @FindBy(xpath = "//span[contains(text(),'Covering Your Care & Financial Assistance')]") public WebElement coveringYourCareAndFinancialAssistance1;
    ...
    public void checkCoveringYourCareAndFinancialAssistance(){

        coveringYourCareAndFinancialAssistance1.click();
    }
