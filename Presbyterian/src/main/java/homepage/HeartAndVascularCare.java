...
public class HeartAndVascularCare extends WebAPI {
    ...
    @FindBy(xpath = "//span[contains(text(),'Urgent Care Clinics')]") public WebElement heartAndVascularCare1;
    ...
    public void checkHeartAndVascularCare(){

       heartAndVascularCare1.click();
    }
