...
public class SupportingServices extends WebAPI {
    ...
    @FindBy(xpath = "//span[contains(text(),'Supporting Services')]") public WebElement supportingServices1;
    ...
    public void checkSupportingServices(){

        supportingServices1.click();
    }
