...
public class WoundAndOstomyCenter extends WebAPI {
    ...
    @FindBy(xpath = "//span[contains(text(),'Wound and Ostomy Center')]") public WebElement woundAndOstomyCenter1;
    ...
    public void checkWoundAndOstomyCenter(){

       woundAndOstomyCenter1.click();
    }
